...
- [x] Finish the function for ranking features with rated components.
- [x] Finish the main function with parameters.
- [x] Design a method for visualizing the final pseudo decision tree.
- [x] The result of fitting is somewhat random at the time. Try to make it reproducible when needed.
- [x] Hide the plotting result of `boot.comp()`. Only keep it in test mode.
